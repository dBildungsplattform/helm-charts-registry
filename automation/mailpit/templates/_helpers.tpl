...
{{- define "mailpit.generatePasswordString" -}}
{{- range . }}{{(print .username ":" .password " ")}}{{- end }}
{{- end }}

{{- define "mailpit.generatePasswordFile" -}}
{{ include "mailpit.generatePasswordString" . | trimSuffix " " | quote }}
{{- end }}
...
*/}}
{{- define "mailpit.secretName" -}}
{{- if .Values.auth.existingSecret }}
{{- .Values.auth.existingSecret }}
{{- else }}
{{- include "mailpit.fullname" . }}
{{- end }}
{{- end }}
