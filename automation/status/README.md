...
| tolerations | list | `[]` |  |
| valkey | object | `{"enabled":true,"haMode":{"enabled":false},"useDeploymentWhenNonHA":false}` | Valkey settings. See https://github.com/dBildungsplattform/dbp-valkey/tree/main for details |
