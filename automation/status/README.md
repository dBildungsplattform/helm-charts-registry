...
![Version: 0.0.0](https://img.shields.io/badge/Version-0.0.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.5.3](https://img.shields.io/badge/AppVersion-v2.5.3-informational?style=flat-square)
...
| ingress.hosts | list | `[{"host":"chart-example.local","paths":[{"path":"/","pathType":"Prefix"}]}]` | The list of hostnames to be covered with this ingress record. |
...
| postgresql | object | `{"auth":{"database":"status","existingSecret":"","password":"","postgresPassword":"","secretKeys":{"adminPasswordKey":"","userPasswordKey":""},"username":"status"},"enabled":true,"primary":{"persistence":{"enabled":true,"size":"10Gi"}},"service":{"ports":{"postgresql":5432}}}` | Postgresql settings. See https://github.com/bitnami/charts/tree/master/bitnami/postgresql fro details |
| replicaCount | int | `1` |  |
...
| runAsUser | int | `1001` | Settings for security context of the container |
| seedData | object | `{}` |  |
...
| tolerations | list | `[]` |  |
| valkey | object | `{"enabled":true,"haMode":{"enabled":false},"useDeploymentWhenNonHA":false}` | Valkey settings. See https://github.com/dBildungsplattform/dbp-valkey/tree/main fro details |
