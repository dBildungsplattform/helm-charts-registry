...
![Version: 0.0.42](https://img.shields.io/badge/Version-0.0.42-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 4.5.8](https://img.shields.io/badge/AppVersion-4.5.8-informational?style=flat-square)
...
| global.moodlePlugins.availability_cohort.enabled | bool | `false` |  |
| global.moodlePlugins.block_stash.enabled | bool | `false` |  |
| global.moodlePlugins.board.enabled | bool | `false` |  |
...
| global.moodlePlugins.completion_progress.enabled | bool | `false` |  |
| global.moodlePlugins.coursearchiver.enabled | bool | `false` |  |
| global.moodlePlugins.coursecertificate.enabled | bool | `false` |  |
| global.moodlePlugins.customfield_dynamic.enabled | bool | `false` |  |
| global.moodlePlugins.dash.enabled | bool | `false` |  |
| global.moodlePlugins.dynamic_cohorts.enabled | bool | `false` |  |
| global.moodlePlugins.etherpadlite.enabled | bool | `false` |  |
| global.moodlePlugins.filtercodes.enabled | bool | `false` |  |
| global.moodlePlugins.flexsections.enabled | bool | `false` |  |
...
| global.moodlePlugins.mod_checklist.enabled | bool | `false` |  |
| global.moodlePlugins.multitopic.enabled | bool | `false` |  |
| global.moodlePlugins.oidc.enabled | bool | `false` |  |
| global.moodlePlugins.pdfannotator.enabled | bool | `false` |  |
| global.moodlePlugins.qtype_stack.enabled | bool | `false` |  |
...
| global.moodlePlugins.shortcodes.enabled | bool | `false` |  |
...
| global.moodlePlugins.usersuspension.enabled | bool | `false` |  |
